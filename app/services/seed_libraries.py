...
LIBRARIES = [('general', 'Libreria Generale', 'Test per general', 'general', ['general']),
 ...
 ('athletics', 'Preparazione Atletica', 'Piani allenamento, nutrizione, recupero e strategia sportiva', 'athletics', ['athletics', 'sport', 'training', 'nutrizione', 'recupero']),
 ('marketing', 'Marketing', 'Strategie marketing, branding, comunicazione commerciale', 'marketing', ['marketing', 'branding', 'comunicazione']),
 ('business_strategy', 'Strategia Aziendale', 'Pianificazione strategica, pivot, crescita e internazionalizzazione', 'business_strategy', ['strategia', 'crescita', 'internazionalizzazione', 'pivot']),
 ('communication', 'Comunicazione', 'Comunicazione interna, crisis management, pubbliche relazioni', 'communication', ['comunicazione', 'crisis', 'pr', 'relazioni'])]
...
SEED_LIBRARY_TEST_CASES = [{'library_id': 'general',
 ...
 {'library_id': 'agent_development',
  ...
  'enabled': True},
 {'library_id': 'legal',
  'test_type_id': 'contextual_insight',
  'title': 'Legal-Responsabilita Prodotto',
  'description': 'Analizza la posizione legale e proponi strategie',
  'input_text': 'Cliente: Ho comprato una stampante su MarketplaceX da un venditore privato. Dopo due giorni ha preso fuoco danneggiando la scrivania.\nAvvocato: Ha la fattura? Il venditore e un privato o un negozio?\nCliente: Si, ho la fattura. Il venditore e un privato, non un\'attivita commerciale.',
  'context_text': 'Codice Civile art. 1490: garanzia per vizi. Responsabilita del produttore D.Lgs. 206/2005. Marketplace responsabile solo se non comunica identita venditore.',
  'expected_output_json': '{"domain": "legal", "expected_insight_count": {"min": 3, "max": 6}, "must_include_themes": ["responsabilita", "onere della prova", "garanzia"], "must_avoid_themes": ["penale", "dolo"], "depth": "legale"}',
  'tags_json': '["legal", "contestuale"]',
  'difficulty': 'medium',
  'risk_level': 'low',
  'enabled': True},
 {'library_id': 'legal',
  'test_type_id': 'contextual_insight',
  'title': 'Legal-Diritto Oblio GDPR',
  'description': 'Analizza la richiesta di diritto all\'oblio e proponi strategia',
  'input_text': 'DPO: Un ex dipendente chiede la cancellazione di tutti i suoi dati personali, inclusi quelli nei backup.\nDirigente Marketing: Ma ci servono per le statistiche trimestrali e la newsletter.\nDPO: Il GDPR art.17 prevede il diritto alla cancellazione senza ingiustificato ritardo.',
  'context_text': 'GDPR art.17 Diritto alla cancellazione. Eccezioni: obblighi legali, interesse pubblico, archiviazione statistica. Conservazione dati giustificata solo se necessaria.',
  'expected_output_json': '{"domain": "legal", "expected_insight_count": {"min": 3, "max": 5}, "must_include_themes": ["GDPR", "base giuridica", "diritto oblio", "conservazione"], "must_avoid_themes": ["ignorare richiesta", "cancellare backup senza criterio"], "depth": "legale"}',
  'tags_json': '["legal", "contestuale", "gdpr"]',
  'difficulty': 'medium',
  'risk_level': 'medium',
  'enabled': True},
 {'library_id': 'legal',
  'test_type_id': 'contextual_insight',
  'title': 'Legal-Clausola Penale Contratto',
  'description': 'Analizza la validita della clausola penale e proponi modifiche',
  'input_text': 'Imprenditore: Il fornitore ha consegnato con 30 giorni di ritardo. Il contratto prevede penale di 500 euro al giorno. Sono 15.000 euro.\nConsulente: La penale e manifestamente eccessiva rispetto al valore del contratto (50.000 euro).\nImprenditore: Posso trattenerla dalla fattura?',
  'context_text': 'Codice Civile art.1382-1384: riduzione penale eccessiva. Giurisprudenza: penale oltre 10 percento valore contratto puo essere ridotta dal giudice.',
  'expected_output_json': '{"domain": "legal", "expected_insight_count": {"min": 3, "max": 5}, "must_include_themes": ["penale", "riduzione", "contratto", "trattenuta"], "must_avoid_themes": ["penale", "inadempimento totale"], "depth": "legale"}',
  'tags_json': '["legal", "contestuale", "contratti"]',
  'difficulty': 'medium',
  'risk_level': 'low',
  'enabled': True},
 {'library_id': 'ecommerce',
  'test_type_id': 'contextual_insight',
  'title': 'Ecomm-Go-To-Market SaaS',
  'description': 'Proponi strategia di go-to-market per SaaS B2B',
  'input_text': 'CEO: Abbiamo un SaaS per la gestione inventario PMI. Funziona, ma non sappiamo come venderlo.\nConsulente: Qual e il target? Quante PMI nel vostro settore?\nCEO: PMI manifatturiere, 500-1000 dipendenti. In Italia sono circa 3000.',
  'context_text': 'Mercato SaaS Italia 2026: crescita 18 percento anno. PMI digitalizzate al 40 percento. Canali: LinkedIn Ads, fiere settore, partnership system integrator.',
  'expected_output_json': '{"domain": "commerciale", "expected_insight_count": {"min": 3, "max": 6}, "must_include_themes": ["target", "canale", "pricing", "acquisizione"], "must_avoid_themes": ["B2C", "consumer"], "depth": "commerciale"}',
  'tags_json': '["ecommerce", "contestuale", "saas"]',
  'difficulty': 'medium',
  'risk_level': 'low',
  'enabled': True},
 {'library_id': 'ecommerce',
  'test_type_id': 'contextual_insight',
  'title': 'Ecomm-Crisis Recensioni',
  'description': 'Gestisci crisi reputazionale da recensioni negative',
  'input_text': 'Community Manager: Abbiamo 47 recensioni a 1 stella in tre giorni. Tutte menzionano "prodotto arrivato rotto".\nCEO: Il corriere e nuovo, abbiamo cambiato settimana scorsa.\nCommunity Manager: I clienti vogliono rimborso immediato.',
  'context_text': 'Crisis management ecommerce: rispondere entro 24 ore, offrire soluzione concreta, monitorare sentiment. 78 percento clienti torna se problema risolto rapidamente.',
  'expected_output_json': '{"domain": "commerciale", "expected_insight_count": {"min": 3, "max": 6}, "must_include_themes": ["rimborso", "comunicazione", "corriere", "fiducia"], "must_avoid_themes": ["ignorare recensioni", "scaricare colpa"], "depth": "comunicazione"}',
  'tags_json': '["ecommerce", "contestuale", "crisis"]',
  'difficulty': 'medium',
  'risk_level': 'medium',
  'enabled': True},
 {'library_id': 'academy',
  'test_type_id': 'contextual_insight',
  'title': 'Academy-Percorso STEM',
  'description': 'Consiglia percorso universitario STEM personalizzato',
  'input_text': 'Studente: Mi piacciono matematica e fisica, ma non so se fare Ingegneria o Fisica pura.\nOrientatore: Che tipo di lavoro ti immagini dopo?\nStudente: Mi piacerebbe fare ricerca applicata, non solo teoria.',
  'context_text': 'Offerta formativa STEM 2026: Ingegneria Fisica (Polimi), Fisica (UniBo), Data Science (UniTn). Sbocchi: R&D industriale, centri ricerca, startup deep tech.',
  'expected_output_json': '{"domain": "tecnico", "expected_insight_count": {"min": 3, "max": 6}, "must_include_themes": ["percorso", "ricerca applicata", "sbocchi", "competenze"], "must_avoid_themes": ["abbandonare STEM"], "depth": "tecnico"}',
  'tags_json': '["academy", "contestuale", "stem"]',
  'difficulty': 'easy',
  'risk_level': 'low',
  'enabled': True},
 {'library_id': 'athletics',
  'test_type_id': 'contextual_insight',
  'title': 'Athletics-Maratona Infortunio',
  'description': 'Piano allenamento maratona con infortunio pregresso',
  'input_text': 'Atleta: Devo correre la maratona tra 16 settimane. Due mesi fa ho avuto una tendinite al ginocchio destro.\nFisioterapista: Il ginocchio ora e stabile ma devi rinforzare quadricipite e glutei.\nCoach: Non puoi fare piu di 3 uscite a settimana e devi alternare con nuoto.',
  'context_text': 'Preparazione maratona: periodo base 8 settimane (aerobico), specifico 6 settimane (ritmo gara), tapering 2 settimane. Carico progressivo max +10 percento settimana.',
  'expected_output_json': '{"domain": "preparazione atletica", "expected_insight_count": {"min": 3, "max": 6}, "must_include_themes": ["carico progressivo", "rinforzo", "recupero", "alimentazione"], "must_avoid_themes": ["farmaci", "doping", "sovraccarico"], "depth": "tecnico"}',
  'tags_json': '["athletics", "contestuale", "running"]',
  'difficulty': 'medium',
  'risk_level': 'low',
  'enabled': True},
 {'library_id': 'athletics',
  'test_type_id': 'contextual_insight',
  'title': 'Athletics-Nuoto Pre-Gara',
  'description': 'Piano nutrizionale e mentale pre-gara nuoto',
  'input_text': 'Atleta: Ho la finale regionale 200 stile libero tra 5 giorni. Sono nervoso.\nNutrizionista: Cosa mangi nei giorni pre-gara?\nAtleta: Pasta la sera prima, ma a volte mi sento pesante in acqua.',
  'context_text': 'Nutrizione nuoto: carico glicogeno 48 ore pre-gara. Pasti leggeri 3 ore prima. Idratazione 500ml ogni 2 ore. Tecniche respirazione pre-gara.',
  'expected_output_json': '{"domain": "preparazione atletica", "expected_insight_count": {"min": 3, "max": 5}, "must_include_themes": ["nutrizione", "idratazione", "recupero", "mentale"], "must_avoid_themes": ["integratori non approvati", "digiuno"], "depth": "tecnico"}',
  'tags_json': '["athletics", "contestuale", "nuoto"]',
  'difficulty': 'medium',
  'risk_level': 'low',
  'enabled': True},
 {'library_id': 'marketing',
  'test_type_id': 'contextual_insight',
  'title': 'Marketing-Rebranding 40 Anni',
  'description': 'Strategia di rebranding azienda familiare storica',
  'input_text': 'CEO: Mio padre ha fondato l\'azienda nel 1985. Il logo e lo stesso da 40 anni. I giovani non ci considerano.\nAgenzia: Qual e il valore che volete comunicare?\nCEO: Qualita artigianale, ma anche innovazione. Siamo passati al digitale da 3 anni.',
  'context_text': 'Rebranding: mantenere heritage ma modernizzare. Target under 35: Instagram e TikTok. Mantenere clientela storica over 50. Budget tipico 50-100K per PMI.',
  'expected_output_json': '{"domain": "marketing", "expected_insight_count": {"min": 3, "max": 6}, "must_include_themes": ["heritage", "target giovane", "digitale", "posizionamento"], "must_avoid_themes": ["cancellare storia", "alienare clienti storici"], "depth": "commerciale"}',
  'tags_json': '["marketing", "contestuale", "branding"]',
  'difficulty': 'medium',
  'risk_level': 'medium',
  'enabled': True},
 {'library_id': 'marketing',
  'test_type_id': 'contextual_insight',
  'title': 'Marketing-Lancio Eco Green',
  'description': 'Piano lancio prodotto eco-sostenibile',
  'input_text': 'Product Manager: Abbiamo sviluppato una borraccia in bioplastica compostabile. Costa 30 percento piu della plastica tradizionale.\nSustainability Officer: Dobbiamo certificare la filiera e comunicare l\'impatto.\nInvestitore: Come dimostrate che non e greenwashing?',
  'context_text': 'Mercato prodotti sostenibili: crescita 22 percento anno. Certificazioni: OK Compost, Carbon Trust. Greenwashing: sanzioni AGCM fino a 5 milioni.',
  'expected_output_json': '{"domain": "marketing", "expected_insight_count": {"min": 3, "max": 6}, "must_include_themes": ["certificazione", "posizionamento", "target", "comunicazione impatto"], "must_avoid_themes": ["greenwashing", "claim non verificabili"], "depth": "commerciale"}',
  'tags_json': '["marketing", "contestuale", "sostenibilita"]',
  'difficulty': 'medium',
  'risk_level': 'medium',
  'enabled': True},
 {'library_id': 'business_strategy',
  'test_type_id': 'contextual_insight',
  'title': 'Strategy-Pivot Post-Crisi',
  'description': 'Pianifica pivot aziendale dopo crisi di mercato',
  'input_text': 'Founder: Il nostro prodotto core (software HR) ha perso 40 percento fatturato in 6 mesi. I competitor offrono AI.\nCFO: Abbiamo cassa per 9 mesi al ritmo attuale.\nAdvisor: Quali asset avete che i competitor non hanno?',
  'context_text': 'Pivot aziendale: identificare asset differenzianti, validare nuovo mercato in 90 giorni, MVP approach. Esempi: Slack (da gioco a enterprise), Twitter (da podcast a social).',
  'expected_output_json': '{"domain": "strategia aziendale", "expected_insight_count": {"min": 3, "max": 6}, "must_include_themes": ["cassa", "asset differenziante", "nuovo mercato", "MVP"], "must_avoid_themes": ["licenziare senza criterio", "ignorare competitor"], "depth": "strategico"}',
  'tags_json': '["business_strategy", "contestuale", "pivot"]',
  'difficulty': 'hard',
  'risk_level': 'high',
  'enabled': True},
 {'library_id': 'business_strategy',
  'test_type_id': 'contextual_insight',
  'title': 'Strategy-Espansione Giappone',
  'description': 'Piano ingresso mercato giapponese',
  'input_text': 'CEO: Vogliamo entrare in Giappone con la nostra piattaforma e-learning B2B.\nCountry Manager: Il mercato giapponese richiede localizzazione spinta e partnership locale.\nCEO: Abbiamo budget di 500K per il primo anno.',
  'context_text': 'Mercato Giappone: 126M popolazione, digitalizzazione corporate in crescita. Barriere: lingua, fiducia, gerarchia decisionale. Canali: partner locali, eventi B2B.',
  'expected_output_json': '{"domain": "strategia aziendale", "expected_insight_count": {"min": 3, "max": 6}, "must_include_themes": ["localizzazione", "partner", "budget", "cultura business"], "must_avoid_themes": ["approccio occidentale diretto", "ignorare barriera lingua"], "depth": "strategico"}',
  'tags_json': '["business_strategy", "contestuale", "internazionalizzazione"]',
  'difficulty': 'hard',
  'risk_level': 'medium',
  'enabled': True},
 {'library_id': 'communication',
  'test_type_id': 'contextual_insight',
  'title': 'Comm-Crisi Ambientale',
  'description': 'Prepara comunicazione crisi ambientale',
  'input_text': 'PR Manager: C\'e una fuga di solventi nel fiume vicino allo stabilimento. I media stanno arrivando.\nCEO: Dobbiamo dire che non e colpa nostra?\nGiornalista: Quali azioni concrete state prendendo per contenere il danno?',
  'context_text': 'Crisis communication: assumere responsabilita, comunicare azioni concrete, evitare negazione. Caso Tylenol 1982: richiamo totale prodotto. Caso BP 2010: negazione iniziale disastrosa.',
  'expected_output_json': '{"domain": "comunicazione", "expected_insight_count": {"min": 3, "max": 5}, "must_include_themes": ["responsabilita", "azioni concrete", "trasparenza", "stakeholder"], "must_avoid_themes": ["negazione", "scaricare colpa", "no comment"], "depth": "comunicazione"}',
  'tags_json': '["communication", "contestuale", "crisis"]',
  'difficulty': 'medium',
  'risk_level': 'high',
  'enabled': True},
 {'library_id': 'communication',
  'test_type_id': 'contextual_insight',
  'title': 'Comm-Negoziazione Sindacale',
  'description': 'Piano comunicazione interna per negoziazione sindacale',
  'input_text': 'HR Director: Il sindacato chiede aumento 8 percento. Noi offriamo 3 percento piu welfare.\nSindacalista: I lavoratori vogliono contante, non buoni pasto.\nCEO: Dobbiamo comunicare ai dipendenti perche non possiamo dare 8 percento senza farli sentire svalutati.',
  'context_text': 'Comunicazione interna: trasparenza sui vincoli di bilancio, ascolto attivo, evitare linguaggio conflittuale. Tecniche negoziazione: BATNA, ZOPA.',
  'expected_output_json': '{"domain": "comunicazione", "expected_insight_count": {"min": 3, "max": 6}, "must_include_themes": ["trasparenza", "ascolto", "welfare", "dati bilancio"], "must_avoid_themes": ["ultimatum", "minaccia", "linguaggio ostile"], "depth": "comunicazione"}',
  'tags_json': '["communication", "contestuale", "hr"]',
  'difficulty': 'hard',
  'risk_level': 'medium',
  'enabled': True}]
