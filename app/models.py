...
class ConfiguredModel(Base):
    ...
    benchmark_temp_min = Column(Float, nullable=True)
    benchmark_temp_mid = Column(Float, nullable=True)
    benchmark_temp_max = Column(Float, nullable=True)
    created_at = Column(DateTime, default=lambda: datetime.now(timezone.utc))
    updated_at = Column(DateTime, default=lambda: datetime.now(timezone.utc), onupdate=lambda: datetime.now(timezone.utc))
...
class TestRun(Base):
    ...
    benchmark_config_json = Column(Text, default="{}")
...
class TestResult(Base):
    ...
    repetition_index = Column(Integer, nullable=True)
    started_at = Column(DateTime, nullable=True)
    completed_at = Column(DateTime, nullable=True)
